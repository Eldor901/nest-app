...
const task_status_validation_pipes_1 = require("./pipes/task-status-validation.pipes");
...
__decorate([
    ...
    __param(0, common_1.Param('id')),
    __param(1, common_1.Body('status', task_status_validation_pipes_1.TaskStatusValidationPipes)),
    __metadata("design:type", Function),
